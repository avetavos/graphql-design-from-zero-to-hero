...
export default defineConfig({
  ...
  integrations: [starlight({
      ...
      head: [
        { tag: 'script', attrs: { type: 'module', src: '/graphql/enhance.js' } },
        { tag: 'link', attrs: { rel: 'manifest', href: '/graphql/manifest.webmanifest' } },
        { tag: 'link', attrs: { rel: 'apple-touch-icon', href: '/graphql/apple-touch-icon.png' } },
        { tag: 'link', attrs: { rel: 'icon', type: 'image/png', sizes: '192x192', href: '/graphql/icon-192.png' } },
        ...
        { tag: 'script', content: "if('serviceWorker' in navigator){window.addEventListener('load',function(){navigator.serviceWorker.register('/graphql/sw.js',{scope:'/graphql/'}).catch(function(){})})}" },
      ],
      defaultLocale: 'en',
      locales: {
