...
export default defineConfig({
  ...
  integrations: [starlight({
      ...
      sidebar: [
        { label: 'GraphQL Foundations', collapsed: true, items: [{ autogenerate: { directory: 'graphql-foundations' } }] },
        { label: 'Schema Design', collapsed: true, items: [{ autogenerate: { directory: 'schema-design' } }] },
        { label: 'Queries & Resolvers', collapsed: true, items: [{ autogenerate: { directory: 'queries-and-resolvers' } }] },
        { label: 'Mutations & Subscriptions', collapsed: true, items: [{ autogenerate: { directory: 'mutations-and-subscriptions' } }] },
        { label: 'Pagination & Relationships', collapsed: true, items: [{ autogenerate: { directory: 'pagination-and-relationships' } }] },
        { label: 'Errors & Validation', collapsed: true, items: [{ autogenerate: { directory: 'errors-and-validation' } }] },
        { label: 'Security & Performance', collapsed: true, items: [{ autogenerate: { directory: 'security-and-performance' } }] },
        { label: 'Tooling, Federation & Building', collapsed: true, items: [{ autogenerate: { directory: 'tooling-federation-building' } }] },
      ],
      }), preact()],
});