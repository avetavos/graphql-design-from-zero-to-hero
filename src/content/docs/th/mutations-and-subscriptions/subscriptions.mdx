...
>
> **AWS AppSync:**
> - subscription รับ argument ได้โดยตรง เช่น `updatedPost(id: ID!, author: String)` แล้ว client subscribe ด้วยค่าที่ต้องการ ([AWS AppSync real-time subscriptions](https://docs.aws.amazon.com/appsync/latest/devguide/aws-appsync-real-time-data.html)) เพื่อไม่ให้รับ event ที่ไม่เกี่ยวข้องจากทั้งระบบ
>
> **Hasura:**
> - live query subscription ส่งผลลัพธ์ใหม่เฉพาะเมื่อข้อมูลที่ subscribe ไว้เปลี่ยนจริง ๆ (insert/update/delete) ([Hasura subscriptions docs](https://hasura.io/docs/2.0/subscriptions/overview/))
> - filter ผ่าน argument/`where` ตั้งแต่ subscription query เพื่อ scope เฉพาะข้อมูลที่ client สนใจ
