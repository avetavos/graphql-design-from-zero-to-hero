...
>
> **GraphQL Yoga:**
> - เป็น spec-compliant GraphQL server ที่ไม่ผูก resolver กับ data source ใดเป็นพิเศษ — resolver เดียวเรียก database, REST API, หรือ cache ก็ได้ ([Yoga docs](https://the-guild.dev/graphql/yoga-server))
>
> **Prisma:**
> - ORM ยอดนิยมสำหรับ resolver ที่ต่อกับฐานข้อมูล ([Prisma Client docs](https://www.prisma.io/docs/orm/prisma-client))
