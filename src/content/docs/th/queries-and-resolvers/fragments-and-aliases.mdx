...
>
> **Relay (Meta/Facebook):**
> - บังคับ pattern "colocation" — component ประกาศ fragment ของตัวเองที่ต้องการ ([Relay docs: Thinking in GraphQL](https://relay.dev/docs/tutorial/fragments-1/))
> - query ระดับ page รวม fragment จาก component ทั้งหมดอัตโนมัติผ่าน compiler ของ Relay
>
> **Apollo Client:**
> - `useFragment` hook (stable ตั้งแต่ v3.8) ทำให้ component subscribe เฉพาะ field ที่ตัวเองประกาศใน fragment โดยไม่ trigger network request เพิ่ม ([`useFragment` docs](https://www.apollographql.com/docs/react/api/react/useFragment))
