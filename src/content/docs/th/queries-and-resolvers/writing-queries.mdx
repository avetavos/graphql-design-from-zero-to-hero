...
>
> **GitHub:**
> - ตัวอย่าง query ใน GitHub GraphQL documentation ตั้งชื่อ operation ชัดเจนแทบทุกจุด ([GitHub GraphQL docs](https://docs.github.com/en/graphql))
> - operation name ช่วยให้ monitoring และ debugging log ทำงานได้แม่นยำขึ้น
>
> **Apollo Client:**
> - cache key จริง ๆ มาจาก `__typename` + `id` ของ object ไม่ใช่ operation name แต่ operation name ยังสำคัญมากสำหรับ DevTools และ Apollo Studio ([Apollo Client caching docs](https://www.apollographql.com/docs/react/caching/overview))
> - named query ทำให้เห็น operation แยกกันชัดเจนใน Apollo Studio tracking
