...
>
> **Apollo Server:**
> - plugin hook `parsingDidStart`, `validationDidStart`, `executionDidStart` ให้ track ได้ทุก phase ([Apollo Server plugin event reference](https://www.apollographql.com/docs/apollo-server/integrations/plugins-event-reference))
>
> **Yoga (GraphQL Yoga):**
> - ใช้ Envelop plugin system ที่ intercept ทุก phase ของ lifecycle ([Yoga docs](https://the-guild.dev/graphql/yoga-server))
