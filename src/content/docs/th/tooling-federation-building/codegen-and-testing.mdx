...
> - plugin-based: generate resolver type, React hooks, Zod schema จาก GraphQL schema ([GraphQL Code Generator docs](https://the-guild.dev/graphql/codegen))
> - Apollo เองมี legacy codegen tool (`apollo-tooling`) ที่เลิกดูแลแล้ว และเอกสาร Apollo Client ปัจจุบันแนะนำให้ใช้ GraphQL Code Generator แทน ([Apollo Client codegen docs](https://www.apollographql.com/docs/react/development-testing/graphql-codegen))
