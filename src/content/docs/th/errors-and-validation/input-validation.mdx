...
>
> **Shopify:**
> - mutation return `userErrors: [UserError!]!` สำหรับ business validation ([Shopify `UserError` docs](https://shopify.dev/docs/api/admin-graphql/latest/objects/UserError))
> - `UserError` มี `field` (array ของ field path) และ `message`
> - client รู้ว่า field ไหนผิดและแสดง error ที่ field นั้นได้
>
> **Zod + GraphQL (แพตเทิร์นทั่วไป ไม่ผูกกับผลิตภัณฑ์ใดผลิตภัณฑ์หนึ่ง):**
