...
>
> **Relay Convention:**
> - Relay Input Object Mutations Specification กำหนดให้ mutation ทุกตัวรับ `input: XxxInput!` argument เดียว ([สเปก](https://chentsulin.github.io/relay/graphql/mutations.htm))
> - pattern นี้ทำให้ schema evolve ได้โดยไม่เปลี่ยน mutation signature
>
> **GitHub:**
> - ใช้ naming convention `CreateIssueInput`, `UpdateIssueInput`, `CloseIssueInput` ([GitHub GraphQL mutation reference](https://docs.github.com/en/graphql/reference/mutations))
