...
In the [previous lesson](/graphql-design-from-zero-to-hero/en/graphql-foundations/) we sketched GraphQL in one sentence. Now let's slow down and name the four ideas that make it work. Get these four straight and everything else in the course is a refinement of them.
